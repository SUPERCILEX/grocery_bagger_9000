// Majority of this code from Vishal Devriddy
// https://gitlab.cs.washington.edu/vishald/game-analytics
// Port of CSE 481d's Haxe logging API to JS
...
function getLogger(categoryId = 1) {
    window.logger = new CapstoneLogger(
        202202,
        "grocery",
        "d6537598783e19e1d6e40b6e01860008",
        categoryId
    );
